...
public class TableItemRenderer extends BlockEntityWithoutLevelRenderer {
    public static TableItemRenderer INSTANCE = new TableItemRenderer();

    private final TableBlockEntity fakeBE = new TableBlockEntity(BlockPos.ZERO, BlockRegistry.TABLE.get().defaultBlockState());
