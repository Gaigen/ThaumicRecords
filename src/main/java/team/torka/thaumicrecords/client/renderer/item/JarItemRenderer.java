...
public class JarItemRenderer extends BlockEntityWithoutLevelRenderer {
    public static JarItemRenderer INSTANCE = new JarItemRenderer();

    private final JarBlockEntity fakeBE = new JarBlockEntity(BlockPos.ZERO, BlockRegistry.JAR.get().defaultBlockState());
