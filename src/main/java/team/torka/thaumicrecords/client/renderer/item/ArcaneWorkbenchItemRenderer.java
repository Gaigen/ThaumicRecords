...
public class ArcaneWorkbenchItemRenderer extends BlockEntityWithoutLevelRenderer {
    public static final ArcaneWorkbenchItemRenderer INSTANCE = new ArcaneWorkbenchItemRenderer();
    private final ArcaneWorkbenchBlockEntity fakeBE = new ArcaneWorkbenchBlockEntity(BlockPos.ZERO, BlockRegistry.ARCANE_WORKBENCH.get().defaultBlockState());

    public ArcaneWorkbenchItemRenderer() {
    ...
    public IClientItemExtensions getExtensions() {
        return new IClientItemExtensions() {
            ...
            public BlockEntityWithoutLevelRenderer getCustomRenderer() {
                return ArcaneWorkbenchItemRenderer.this;
            }
        };
    }
}