...
public class Node {
    ...
    public Node(String translationKey, ResourceLocation nodeTexture, RenderType renderType, NodeType nodeType, int regenFrequency, float renderSizeModifier, boolean rotate) {
    ...
    public Node(String translationKey, ResourceLocation nodeTexture, RenderType renderType) {
        this(translationKey, nodeTexture, renderType, NodeType.NORMAL, 600, 1, false);
    }
