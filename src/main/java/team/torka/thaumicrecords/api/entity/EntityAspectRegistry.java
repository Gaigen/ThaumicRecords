...
public class EntityAspectRegistry {
    ...
    public static void init() {
        register(EntityType.ZOMBIE, new AspectList().add(AspectRegistry.MORTUUS.getId(), 2)
                .add(AspectRegistry.HUMANUS.getId(), 1)
                .add(AspectRegistry.TERRA.getId(), 1));

        register(EntityType.SKELETON, new AspectList().add(AspectRegistry.MORTUUS.getId(), 3)
                .add(AspectRegistry.HUMANUS.getId(), 1)
                .add(AspectRegistry.TERRA.getId(), 1));
        ...
        register(EntityType.CHICKEN, new AspectList().add(AspectRegistry.BESTIA.getId(), 2)
                .add(AspectRegistry.VOLATUS.getId(), 2)
                .add(AspectRegistry.AER.getId(), 1));
    }
