...
public class BlockTagsGenerator extends BlockTagsProvider {
    ...
    protected void addTags(HolderLookup.Provider provider) {
        ...
        this.tag(BlockTags.MINEABLE_WITH_PICKAXE).add(BlockRegistry.THAUMIUM_BLOCK.get());
        this.tag(BlockTags.MINEABLE_WITH_PICKAXE).add(BlockRegistry.VOID_BLOCK.get());
        this.tag(BlockTags.MINEABLE_WITH_PICKAXE).add(BlockRegistry.AMBER_BLOCK.get());
        this.tag(BlockTags.MINEABLE_WITH_PICKAXE).add(BlockRegistry.AMBER_BRICK.get());
        this.tag(BlockTags.MINEABLE_WITH_PICKAXE).add(BlockRegistry.OBSIDIAN_TILE.get());
        this.tag(BlockTags.MINEABLE_WITH_PICKAXE).add(BlockRegistry.TALLOW_BLOCK.get());
        this.tag(BlockTags.MINEABLE_WITH_PICKAXE).add(BlockRegistry.ARCANE_STONE.get());
        this.tag(BlockTags.MINEABLE_WITH_PICKAXE).add(BlockRegistry.ARCANE_STONE_BRICK.get());
        this.tag(BlockTags.MINEABLE_WITH_PICKAXE).add(BlockRegistry.FLESH_BLOCK.get());
        this.tag(BlockTags.MINEABLE_WITH_AXE).add(BlockRegistry.DECONSTRUCTION_TABLE.get());
        this.tag(BlockTags.MINEABLE_WITH_AXE).add(BlockRegistry.GREATWOOD_PLANKS.get());
        this.tag(BlockTags.MINEABLE_WITH_AXE).add(BlockRegistry.SILVERWOOD_PLANKS.get());
        this.tag(BlockTags.MINEABLE_WITH_PICKAXE).add(BlockRegistry.ARCANE_STONE_STAIRS.get());
        this.tag(BlockTags.MINEABLE_WITH_AXE).add(BlockRegistry.GREATWOOD_STAIRS.get());
        this.tag(BlockTags.MINEABLE_WITH_AXE).add(BlockRegistry.SILVERWOOD_STAIRS.get());
        this.tag(BlockTags.MINEABLE_WITH_PICKAXE).add(BlockRegistry.ARCANE_STONE_SLAB.get());
        this.tag(BlockTags.MINEABLE_WITH_AXE).add(BlockRegistry.GREATWOOD_SLAB.get());
        this.tag(BlockTags.MINEABLE_WITH_AXE).add(BlockRegistry.SILVERWOOD_SLAB.get());
        this.tag(BlockTags.WOODEN_STAIRS).add(BlockRegistry.GREATWOOD_STAIRS.get());
        this.tag(BlockTags.WOODEN_STAIRS).add(BlockRegistry.SILVERWOOD_STAIRS.get());
        this.tag(BlockTags.WOODEN_SLABS).add(BlockRegistry.GREATWOOD_SLAB.get());
        this.tag(BlockTags.WOODEN_SLABS).add(BlockRegistry.SILVERWOOD_SLAB.get());
        this.tag(BlockTags.PLANKS).add(BlockRegistry.GREATWOOD_PLANKS.get());
        this.tag(BlockTags.PLANKS).add(BlockRegistry.SILVERWOOD_PLANKS.get());
