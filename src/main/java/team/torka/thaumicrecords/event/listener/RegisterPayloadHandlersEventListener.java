...
import team.torka.thaumicrecords.network.handler.InfusionSourcePayloadHandler;
...
import team.torka.thaumicrecords.network.handler.PlayerUnlockResearchHandler;
...
public class RegisterPayloadHandlersEventListener {
    ...
    public static void onRegisterPayloadHandlers(final RegisterPayloadHandlersEvent event) {
        ...
        registrar.playToServer(PlayerUnlockResearchPayload.TYPE, PlayerUnlockResearchPayload.STREAM_CODEC, PlayerUnlockResearchHandler::handle);
        ...
        registrar.playToClient(InfusionSourcePayload.TYPE, InfusionSourcePayload.STREAM_CODEC, InfusionSourcePayloadHandler::handle);
    }
}
